...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.mgt.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.mgt.security.DomainUserDetailsService", "createSpringSecurityUser");
